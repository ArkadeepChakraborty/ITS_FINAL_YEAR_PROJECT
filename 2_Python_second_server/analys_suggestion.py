...
def train_model(csv_file):
    ...
    df = df[~df['CourseName'].str.lower().isin(['medium', 'basic', 'beginner', 'advanced'])]      # Clean unwanted course names

    df['CourseGroup'] = df['CourseName'].apply(group_courses)      # Group similar courses
    ...
    X = df[['Stream', 'Difficulty', 'Percentage']]      # Features
    y = df['CourseGroup']   #target
